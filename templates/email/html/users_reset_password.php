...
<div style="font-size:15px; line-height:1.65; color:#0f172a;">
  ...
  <h1 style="margin:0 0 8px; font-size:22px; font-weight:700; color:#0f172a; line-height:1.3;">Ustaw nowe hasło</h1>
  <p style="margin:0 0 16px; font-size:14px; color:#475569;"><?= h($greeting) ?></p>
  <p style="margin:0 0 20px; color:#334155;">
    Otrzymaliśmy prośbę o reset hasła do Twojego konta w <strong><?= h($appName) ?></strong>.
    Jeśli to była Twoja prośba, kliknij przycisk poniżej, aby ustawić nowe hasło.
  </p>
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:8px 0 20px;">
    <tr>
      <td style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px; padding:14px 18px;">
        <div style="font-weight:700; font-size:13px; color:#0f172a; margin:0 0 8px; text-transform:uppercase; letter-spacing:.4px;">Co dalej?</div>
        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td style="vertical-align:top; padding:2px 8px 2px 0; font-weight:700; color:<?= h($brand) ?>; font-size:13px;">1.</td>
            <td style="font-size:13px; color:#334155;">Otwórz link z przycisku powyżej</td>
          </tr>
          <tr>
            <td style="vertical-align:top; padding:2px 8px 2px 0; font-weight:700; color:<?= h($brand) ?>; font-size:13px;">2.</td>
            <td style="font-size:13px; color:#334155;">Ustaw nowe hasło (min. 8 znaków)</td>
          </tr>
          <tr>
            <td style="vertical-align:top; padding:2px 8px 2px 0; font-weight:700; color:<?= h($brand) ?>; font-size:13px;">3.</td>
            <td style="font-size:13px; color:#334155;">Zaloguj się ponownie</td>
          </tr>
        </table>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <div style="font-size:12px; color:#64748b;">
          Jeśli nie prosiłeś o zmianę hasła — zignoruj tę wiadomość. Twoje konto pozostanie bez zmian.
          Nigdy nie udostępniaj tego linku ani danych logowania osobom trzecim.
        </div>
      </td>
    </tr>
  </table>
