...
$(function () {
  ...
  (function initInvCountryPickers() {
    ...
    if ($vpUI.length && !$vpUI.data('cs-inited')) {
      ...
      // Inicjalizacja stanu "Brak" — gdy sekcja intl widoczna i prefiks pusty (edycja faktury spoza UE)
      // val('') wymagane bo disab lowany field nie pozwala przesłać starer wartości
      if (!initVp && !jQuery('#snapshot-intl-fields').hasClass('d-none')) {
