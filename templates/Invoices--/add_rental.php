...
$this->assign('title', $__isEdit ? 'Edytuj fakturę najmu prywatnego' : 'Faktura najmu prywatnego');
...
$__kindBanners = [
  ...
  'rental'           => ['label' => 'Najem prywatny',       'color' => 'warning',   'icon' => 'ri-home-2-line',        'note' => 'Wystawiana przez osobę fizyczną — dane sprzedawcy z ustawień najmu prywatnego.'],
];
...
<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
  <div>
    <h1 class="page-title fw-medium fs-18 mb-2"><?= $__isEdit ? 'Edytuj fakturę najmu prywatnego' : 'Faktura najmu prywatnego' ?></h1>
    <ol class="breadcrumb mb-0">
      ...
      <li class="breadcrumb-item active" aria-current="page"><?= $__isEdit ? 'Edytuj fakturę najmu prywatnego' : 'Najem prywatny' ?></li>
    </ol>
  </div>
  <div class="btn-list">
  ...
  <div class="col-xxl-12">
    <div class="card custom-card">
      <div class="card-header d-md-flex d-block">
        <div class="card-title">Faktura najmu prywatnego</div>
