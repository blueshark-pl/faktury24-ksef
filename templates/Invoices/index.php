...
$typeLabels = [
    ...
    'credit_note' => ['label' => 'Nota uznaniowa', 'icon' => 'ri-refund-line',             'cls' => 'info'],
          ...
          <tr class="invoice-list"<?= $__hasFx ? ' data-fx-id="' . h($inv->id) . '" data-fx-currency="' . h($__fxCurrency) . '" data-fx-date="' . h($__fxDate) . '" data-fx-rate="' . h($__fxRate) . '"' : '' ?>>
            ...
            <td class="col-type">
              ...
              $typeLabels = [
                ...
                'credit_note' => '<span class="badge bg-info-subtle text-info border border-info-subtle">Nota uznaniowa</span>',
