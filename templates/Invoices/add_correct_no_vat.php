 ...
 */
$this->assign('title', 'Korekta rachunku');
...
<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
  <div>
    <h1 class="page-title fw-medium fs-18 mb-2">Korekta rachunku</h1>
    <ol class="breadcrumb mb-0">
      ...
      <li class="breadcrumb-item active" aria-current="page">Korekta rachunku</li>
    </ol>
  </div>
  <div class="btn-list">
  ...
  <div class="col-xxl-12">
    <div class="card custom-card">
      <div class="card-header d-md-flex d-block">
        <div class="card-title">Korekta rachunku</div>
...
<?php endif; ?>
  ...
  <td colspan="4">
    <table class="table table-sm text-nowrap mb-0 table-borderless">
      <tbody>
        <tr>
          <th scope="row"><div class="fw-medium">Razem netto korekty <span class="sum-currency-label text-muted fw-normal"></span>:</div></th>
          <td><input type="text" id="sum-net" class="form-control invoice-amount-input text-end" value="0.00" readonly></td>
        </tr>
        <tr>
          <th scope="row"><div class="fs-14 fw-medium">Razem brutto korekty <span class="sum-currency-label text-muted fw-normal"></span>:</div></th>
