...
$__pageTitle = $__isEdit ? 'Edytuj fakturę najmu prywatnego' : 'Faktura najmu prywatnego';
...
<?= $this->Form->hidden('kind', ['value' => 'rental']) ?>
...
<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
  <div>
    ...
    <ol class="breadcrumb mb-0">
      ...
      <li class="breadcrumb-item" aria-current="page"><a href="javascript:void(0);">Najem prywatny</a></li>
