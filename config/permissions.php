...
return [
    'CakeDC/Auth.permissions' => [
        ...
        [
            ...
            'action'     => ['index', 'calculate', 'forOrder', 'autosuggest', 'revgeocode', 'deleteRecent', 'saveTemplate', 'aiParseAddress', 'aiCargoWizard', 'aiPricing', 'aiDriverBrief', 'aiRouteOptimizer', 'aiEmailReply'],
        ],
        [
            'role' => '*',
            'plugin' => 'CakeDC/Users',
