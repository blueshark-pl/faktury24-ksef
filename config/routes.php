...
return function (RouteBuilder $routes): void {
    ...
    $routes->scope('/', function (RouteBuilder $builder): void {
        ...
        $builder->get('/crm/pomoc',           ['controller' => 'Leads', 'action' => 'faq']);
        $builder->get('/crm/faq',             ['controller' => 'Leads', 'action' => 'faq']);
        ...
        $builder->connect('/crm/suggest-price', ['controller' => 'Leads', 'action' => 'suggestPriceJson']);
        $builder->post('/crm/quote/{activityId}/save-prices', ['controller' => 'Leads', 'action' => 'savePricesJson'])
            ->setPass(['activityId']);
        $builder->get('/crm/quote/{activityId}/pdf', ['controller' => 'Leads', 'action' => 'quotePdf'])
            ->setPass(['activityId']);
        $builder->post('/crm/quote/{activityId}/send', ['controller' => 'Leads', 'action' => 'sendQuoteJson'])
            ->setPass(['activityId']);
        ...
        // Wyczysc assigned_to_user_id dla wszystkich leadow tej firmy
        $builder->get('/crm/admin/clear-lead-assignments',  ['controller' => 'CrmAdmin', 'action' => 'clearLeadAssignments']);
        $builder->post('/crm/admin/clear-lead-assignments', ['controller' => 'CrmAdmin', 'action' => 'clearLeadAssignments']);
