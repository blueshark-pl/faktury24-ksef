    ...
    <div class="d-flex align-items-center justify-content-center mb-3">
      <div class="authentication-cover-logo">
          <a href="<?= $this->Url->build('/') ?>">
              <img src="<?= $this->Url->assetUrl('/img/logo-faktury24.png') ?>" alt="brand" class="authentication-brand desktop-dark">
          </a>
      </div>
    </div>

    <p class="h4 fw-semibold mb-0 text-center"><?= __d('cake_d_c/users', 'Logowanie') ?></p>
    <p class="mb-0 text-muted fw-normal text-center"><?= __d('cake_d_c/users', 'Witamy ponownie!') ?></p>

    <div class="alert alert-outline-secondary alert-dismissible fade show mt-3" role="alert">
      <div class="d-flex align-items-start">
        <div class="flex-grow-1">
          <div class="fw-semibold">Wersja demo</div>
          <div class="small">Możesz się zalogować używając danych demo:</div>
          <ul class="small mb-2">
            <li>Użytkownik: <code>demo</code></li>
            <li>Hasło: <code>f1f14829e5a74e43b49ec0f58b2b644a</code></li>
          </ul>
          <div class="small text-muted">Dane testowe są kasowane co 24 godziny.</div>
        </div>
        <button type="button" class="btn-close ms-2" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
      </div>
    </div>
      ...
      <div class="col-xl-12">
        ...
        <div class="position-relative mb-3">
          <?= $this->Form->control('username', [
            ...
            'placeholder' => __d('cake_d_c/users', 'Enter User Name'),
            'required' => true,
        ...
        <div class="text-center mt-3">
          <?php
            ...
            if (Configure::read('Users.Email.required')) {
              ...
              //     ['allowed' => true, 'escape' => false, 'class' => 'text-primary']
              //   );
              // }
            }

            if (!empty($parts)) {
              echo '<p class="text-muted mb-0">'.implode(' <span class="text-secondary">|</span> ', $parts).'</p>';
            }
          ?>
        </div>
