    ...
    private function tryExtractQuoteRequest(array $data, $lead, $Acts, $Leads, ConsoleIo $io, $service = null, string $accessToken = ''): int
    {
        ...
        try {
            ...
            $system = "Jestes spedytorem analizujacym maile z zapytaniami o transport. "
                ...
                . "  \"weight_kg\": int, \"pallets\": int, "
                . "  \"pallet_type\": string - TYP PALETY (nie waluta!):"
                . "    EUR = euro paleta 120x80cm (najczestsze, tez EUR-EPAL/EPAL/EURO)"
                . "    IND = paleta przemyslowa 120x100cm (industrial/INDU/IND)"
                . "    PET = paleta PET plastik do napojow (PET/PETV)"
                . "    BOX = box paleta/skrzynia (BOX/GITTERBOX/BOKSPALETA)"
                . "    DISP = paleta dyspozycyjna/jednorazowa (DISP/DISPO/OW-EIN)"
                . "    INNE = inne typy nie pasujace do powyzszych LUB gdy brak info"
                . "    UWAGA: to typ palety, NIE MYL Z WALUTA! Waluta jest w innym polu."
                . "    Jesli w tabeli widzisz np. '26 EUR' to znaczy 26 palet typu EUR - pallets=26, pallet_type='EUR'."
                . "    Jesli w tabeli widzisz 60 PET to pallets=60, pallet_type='PET'."
